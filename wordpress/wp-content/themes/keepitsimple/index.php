  ...
  <body>
    ...
    <div class="landing-page">
      ...
      <div class="introduction-text">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus odit nihil ullam nesciunt quidem iste</p>
      </div>
    </div>
    <!-- End Landing Page -->
    ...
    <div class="container">
      <div class="about-us">
        <div class="info-box">
          <h2>About Us</h2>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis ipsum, tenetur dolores esse magni ratione distinctio! Quod iusto neque fuga, maxime quos nostrum quibusdam dicta deserunt blanditiis non voluptate id?</p>
        </div>
        <div class="image-box">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/about-us.jpg" alt="">
        </div>
      </div>
    </div>
    <!-- End About Us -->
    ...
    <div class="gallery">
      <div class="container">
        ...
        <div class="images-box">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/01.jpg" alt="Image One">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/02.jpg" alt="Image Two">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/03.jpg" alt="Image Three">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/04.jpg" alt="Image Four">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/05.jpg" alt="Image Five">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/06.png" alt="">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/07.jpg" alt="">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/08.jpg" alt="">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/09.jpg" alt="">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/10.jpg" alt="">
        </div>
      </div>
    </div>
    <!-- End Gallery -->
    ...
    <div class="features">
      ...
      <div class="container">
        <div class="feat-box">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/programming.svg" alt="">
          <h4>Development</h4>
          <p>We are professional marketeers, we will do anything you imagine in no time.</p>
        </div>
        <div class="feat-box">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/advertising.svg" alt="">
          <h4>Marketing</h4>
          <p>We are professional marketeers, we will do anything you imagine in no time.</p>
        </div>
        <div class="feat-box">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/hosting-icon.svg" alt="">
          <h4>Hosting</h4>
          <p>We are professional marketeers, we will do anything you imagine in no time.</p>
        </div>
        <div class="feat-box">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/mobile-app.svg" alt="">
          <h4>Mobile Develope</h4>
          <p>We are professional marketeers, we will do anything you imagine in no time.</p>
        </div>
        <div class="feat-box">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/graphic-design.svg" alt="">
          <h4>Cloud and Servers</h4>
          <p>We are professional marketeers, we will do anything you imagine in no time.</p>
        </div>
        <div class="feat-box">
          <img src="<?php echo get_template_directory_uri();?>/assets/imgs/web-design.svg" alt="">
          <h4>Seo</h4>
          <p>We are professional marketeers, we will do anything you imagine in no time.</p>
        </div>
        <div class="clearfix"></div>
    ...
    <!-- Start Footer -->
    <div class="footer">Created With Love By Osama Elzero</div>
    <!-- End Footer -->
    
    <script src="<?php echo get_template_directory_uri();?>/assets/js/master.js"></script>
  </body>
</html>